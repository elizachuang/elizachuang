...
<a href="https://github.com/elizachuang/Crime-Rate-vs-Unemployment-Rate"><img width="400" height="auto" alt="A horizontal banner with a clean white background. On the left side, bold blue text asks the question, DOES LOW UNEMPLOYMENT MEAN LOW CRIME? On the right side, there is a large, faint, light-blue graphic of a human fingerprint, which is partially cropped by the edge of the frame." src="https://github.com/user-attachments/assets/e1f516a4-51b5-4598-9ef2-d47be539c41e" /></a>
